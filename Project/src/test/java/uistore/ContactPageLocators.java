...
public class ContactPageLocators {
    ...
    public static By contact = By.xpath("(//a[text()='Contact Us'])[3]");
    public static By luxury = By.xpath("//a[text()='Luxury Services']");
    public static By store = By.xpath("//a[text()='Store Finder']");
