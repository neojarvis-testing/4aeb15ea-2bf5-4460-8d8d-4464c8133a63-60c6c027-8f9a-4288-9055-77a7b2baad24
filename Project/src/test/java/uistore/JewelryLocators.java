...
public class JewelryLocators {
    ...
    public static By ringVer =  By.xpath("//div[@class='appliedFilter']");
    public static By cocoVer = By.xpath("(//div[@class='appliedFilter'])[2]");
    public static By whiteGoldVer = By.xpath("(//div[@class='appliedFilter'])[3]");
}