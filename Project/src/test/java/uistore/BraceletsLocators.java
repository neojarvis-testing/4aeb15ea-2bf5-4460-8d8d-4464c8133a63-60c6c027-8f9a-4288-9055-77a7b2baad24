...
public class BraceletsLocators {
    ...
    public static By verYellowGold = By.xpath("(//div[@class='appliedFilter'])[1]");
    public static By verDiamond = By.xpath("(//div[@class='appliedFilter'])[3]");
    public static By verBracelets = By.xpath("(//div[@class='appliedFilter'])[4]");
