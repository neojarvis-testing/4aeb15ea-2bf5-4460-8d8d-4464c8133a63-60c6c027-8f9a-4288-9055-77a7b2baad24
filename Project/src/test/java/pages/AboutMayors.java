...
public class AboutMayors extends Base {
     ...
     * Author: Pavan Kumar
     * Description: this contrustor creates a reference for WebDriverHelper
     * variable, Assertion variable and initializes ExtentTest variable
     * Return type: none
     ...
     * Author: Pavan Kumar
     * Description: This method is used to click on About Mayors option available in
     * footer section
     * Return type: void
     * Parameters: NA
     */
    ...
    public void clickOnAboutM() {
        try {
            ...
            helper.hoverOverElement(AboutUsPageLocators.aboutMayors);
     ...
     * Author: Pavan Kumar
     * Description: This method is used to click on Press Room option available in
     * footer section
     * Return type: void
     * Parameters: NA
     */
     ...
     * Author: Pavan Kumar
     * Description: This method is used to click on careers option available in
     * footer section
     * Return type: void
     * Parameters: NA
     */
     ...
     * Author: Pavan Kumar
     * Description: This method is used to click on Sustainability option available
     * in footer section
     * Return type: void
     * Parameters: NA
     */
     ...
     * Author: Pavan Kumar
     * Description: This method is used to click on NewsLetterSIgnUp option
     * available in footer section
     * Return type: void
     * Parameters: NA
     */
     ...
     * Author: Pavan Kumar
     * Description: This method is used to click on Rolex option available in footer
     * section
     * Return type: void
     * Parameters: NA
     */
     ...
     * Author: Pavan Kumar
     * Description: This method is used to click on wedding option available in
     * footer section
     * Return type: void
     * Parameters: NA
     */
     ...
     * Author: Pavan Kumar
     * Description: This method is used to click on brands option available in
     * footer section
     * Return type: void
     * Parameters: NA
     */
     ...
     * Author: Pavan Kumar
     * Description: This method is used to verify About Mayors label and to take a
     * screenshot
     * Return type: void
     * Parameters: NA
     */
    ...
    public void titleVer(String str) {
        try {
            assertt.verifyTitleOfPage(str);
            driver.navigate().to(Base.prop.getProperty("url"));
        } catch (Exception e) {
            Reporter.attachScreenshotToReport("title" + str + "verify", test, "");
        }
    }

    public void urlVer(String url) {
        try {
            assertt.verifyURLOfPage(url);
            driver.navigate().to(Base.prop.getProperty("url"));
        } catch (Exception e) {
            Reporter.attachScreenshotToReport("url" + url + "verify", test, "");
        }
    }
}